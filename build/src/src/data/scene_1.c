...
#include "gbs_types.h"
#include "data/bg_room1.h"
#include "data/scene_1_collisions.h"
#include "data/palette_0.h"
#include "data/palette_1.h"
#include "data/sprite_samusanimatedninesta.h"
...
const struct scene_t scene_1 = {
    ...
    .background = TO_FAR_PTR_T(bg_room1),
    ...
    .reserve_tiles = 0,
    .player_sprite = TO_FAR_PTR_T(sprite_samusanimatedninesta),
    .n_actors = 4,
    .n_triggers = 0,
    .n_sprites = 4,
    .n_projectiles = 0,
